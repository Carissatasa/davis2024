...
with st.expander('About this app'):
  ...
  st.success("**Dari dashboard ini, dapat dilihat bahwa..**\n- Tampilan default dashboard menampilkan filter durasi tahun untuk tahun 2011-2019. Dari filter tersebut, yang ingin saya tunjukkan adalah data judul film dengan pendapatan kotor tertinggi di setiap tahun dalam rentang tahun 2011 hingga 2019. Dataframe menampilkan data tersebut dan divisualisasikan dengan grafik bar untuk melihat dalam rentang tahun tersebut, apa yang bisa dianalisa? Film dengan pendapatan tertinggi dalam rentang tahun tersebut adalah Joker yang rilis tahun 2019 dengan pendapatan sebesar $1078M. Film di tahun 2018 menjadi film dengan pendapatan tertinggi kedua setelah Joker. Secara umum, grafik menunjukkan tren meningkat untuk film dengan pendapatan dari tahun 2011 ke 2019. Maka dari itu dapat disimpulkan bahwa pendapatan dari penayangan film mengalami peningkatan seiring berjalannya waktu. \n- Kemudian saya mengambil data durasi film dari film yang memiliki pendapatan tertinggi di rentang tahun tersebut. Dari grafik bar yang dibuat, hasilnya durasi film tidak memengaruhi tingginya pendapatan dilihat dari film Joker yang memiliki durasi film standar. Yang memiliki durasi film terlama adalah film di tahun 2013 namun pendapatan yang diraih hanya sekitar $400M. \n- Filtering kedua yang saya buat adalah untuk memilih genre film. Default genre yang dipilih adalah Sci-Fi, Action, Adventure, Thriller, dan Mystery. Dari filtering itu, saya membuat 4 grafik utama. Grafik pertama berupa bar chart yang menampilkan film dengan rating tertinggi berdasarkan genre tersebut. Hasilnya film Inception berada di urutan teratas untuk rating tertinggi film dengan genre tersebut. Kemudian, ditampilkan juga total film berdasarkan genre yang divisualisasikan dengan grafik donut. Grafik donut memberikan informasi jumlah film dengan genre tersebut. Selanjutnya, saya juga menampilkan histogram untuk mengetahui distribusi company yang memproduksi film dengan genre tersebut. Hasilnya, company Warner Bros plaing banyak memproduksi film dengan genre tersebut sejumlah 5 film. \nGrafik yang saya tampilkan selanjutnya adalah scatter plot yang menampilkan hubungan antara pendapatan film yang berasal dari United States dan dari negara lain. Hasilnya film dengan pendapatan tertinggi di US dan di dunia rata-rata berasal dari US. Dapat disimpulkan bahwa US menguasai pasar film di dunia karena pendapatan film di US dan di dunia tertinggi.")
